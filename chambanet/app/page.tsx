    ...
    <div className="flex min-h-screen flex-col bg-[#559ff6] text-gray-900 font-sans">
      <header className="w-full bg-[#6aa9f6] px-4 py-4 shadow-[0_12px_24px_rgba(39,77,129,0.35)] sm:px-8">
        ...
        <BrandLogo href="/" size="md" />
          <nav className="hidden gap-6 text-xl font-extrabold text-white md:flex">
      ...
      <main className="flex-grow">
        <section className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-4 py-12 md:grid-cols-2">
          <div className="rounded-[24px] border border-blue-200 bg-white/70 p-6 shadow-[0_14px_28px_rgba(36,73,121,0.25)]">
          ...
          <div id="registro" className="liftable rounded-[26px] border border-blue-200 bg-[#5ea4f7] p-5 shadow-[0_16px_28px_rgba(33,66,109,0.3)] sm:p-8">
            <h2 className="mb-6 text-center text-5xl font-extrabold text-white">Crea una cuenta</h2>
            <form className="space-y-4 text-sm">
              ...
              <button type="submit" className="liftable mx-auto mt-6 block rounded-full bg-white px-10 py-4 text-3xl font-extrabold text-gray-900 hover:bg-blue-50 transition">
                Crear cuenta
              </button>
            </form>
          </div>
        ...
        <section id="objetivo" className="bg-white py-16 px-4">
          <div className="mx-auto max-w-4xl space-y-6 text-center">
            <h2 className="text-5xl font-extrabold">Nuestro propósito</h2>
        ...
        <section id="nosotros" className="bg-[#559ff6] py-16 px-4">
          <div className="mx-auto max-w-5xl space-y-10 text-center text-white">
            <h2 className="text-6xl font-extrabold">Quiénes somos</h2>
            <p className="mx-auto max-w-2xl text-2xl text-blue-100">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              <div className="liftable flex flex-col items-center rounded-2xl bg-blue-400/30 p-6 shadow-[0_10px_20px_rgba(25,53,90,0.2)]">
                ...
                <h3 className="text-3xl font-extrabold">Sibel Sama</h3>
                <p className="mb-2 text-xl text-blue-100">Informática</p>
                <a href="#" className="text-xl text-white/80 hover:text-white transition">@github_sibel</a>
              </div>
              <div className="liftable flex flex-col items-center rounded-2xl bg-blue-400/30 p-6 shadow-[0_10px_20px_rgba(25,53,90,0.2)]">
                <div className="mb-4 h-24 w-24 rounded-full bg-blue-100"></div>
                <h3 className="text-3xl font-extrabold">Nombre Apellido</h3>
                <p className="mb-2 text-xl text-blue-100">Ingeniero</p>
                <a href="#" className="text-xl text-white/80 hover:text-white transition">@gitusername</a>
              </div>
              <div className="liftable flex flex-col items-center rounded-2xl bg-blue-400/30 p-6 shadow-[0_10px_20px_rgba(25,53,90,0.2)]">
                <div className="mb-4 h-24 w-24 rounded-full bg-blue-100"></div>
                <h3 className="text-3xl font-extrabold">Nombre Apellido</h3>
      ...
      <footer className="bg-gradient-to-b from-[#4f8ce0] to-[#36588f] py-8 text-center text-white">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 md:flex-row">
          <p className="text-2xl font-semibold text-balance">¿Qué esperas para unirte a la red de empleos más grande de Chile?</p>
          <p className="mt-2 text-xl md:mt-0">
