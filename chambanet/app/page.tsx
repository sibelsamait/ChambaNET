  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-800 font-sans">
      ...
      <header className="w-full bg-white shadow-sm py-4 px-8 flex justify-between items-center">
        <div className="text-2xl font-bold text-[#FFACCA] font-mono">ChambaNET</div>
        <nav className="hidden md:flex gap-6 text-sm font-medium">
          <a href="#objetivo" className="hover:text-[#FFACCA] transition">Objetivo</a>
          <a href="#nosotros" className="hover:text-[#FFACCA] transition">Nosotros</a>
          <Link href="/login" className="px-4 py-2 border border-[#FFACCA] text-[#FFACCA] rounded-md hover:bg-[#FFACCA] hover:text-white transition">
            Iniciar Sesión
          </Link>
        </nav>
      </header>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            ...
            <form className="space-y-4 text-sm">
              <div className="grid grid-cols-2 gap-4">
                <input type="text" placeholder="R.U.N" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
                <input type="text" placeholder="Nombres" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
                <input type="text" placeholder="Apellido Paterno" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
                <input type="text" placeholder="Apellido Materno" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
              </div>
              <div className="grid grid-cols-3 gap-4">
                <input type="text" placeholder="Calle" className="p-2 border rounded w-full col-span-2 focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
                <input type="text" placeholder="Número" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <select className="p-2 border rounded w-full bg-white focus:outline-none focus:ring-2 focus:ring-[#FFACCA]">
              ...
              <input type="email" placeholder="e-Mail" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
              <div className="grid grid-cols-2 gap-4">
                <input type="password" placeholder="Contraseña" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
                <input type="password" placeholder="Repetir contraseña" className="p-2 border rounded w-full focus:outline-none focus:ring-2 focus:ring-[#FFACCA]" />
              </div>
              <p className="text-xs text-gray-400">La contraseña debe contener mínimo 8 caracteres</p>
              <div className="flex items-center gap-2 mt-2">
                <input type="checkbox" id="terminos" className="accent-[#FFACCA]" />
                <label htmlFor="terminos" className="text-xs text-gray-600">Confirmo haber leído los Términos y Condiciones</label>
              </div>
              <button type="submit" className="w-full bg-[#FFACCA] text-white font-bold py-3 rounded-md hover:bg-pink-400 transition mt-4">
                Crear cuenta
              </button>
            </form>
          </div>
          ...
          <div className="max-w-5xl mx-auto text-center space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center">
                ...
                <p className="text-[#FFACCA] text-sm font-medium mb-2">Informática</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex flex-col items-center">
                ...
                <p className="text-[#FFACCA] text-sm font-medium mb-2">Ingeniero</p>
      ...
      <footer className="bg-gray-900 text-gray-400 py-6 text-center text-sm">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-2 md:mt-0 font-mono text-[#FFACCA]">Hosting por Sibel Sama</p>
        </div>
      </footer>
    </div>
  );
